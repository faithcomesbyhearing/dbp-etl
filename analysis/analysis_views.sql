...
-- VIEW bibles_view
-- PKEY fileset_id, bible_id
-- COLS language_id, versification, numeral_system_id, date, scope, script, derived, copyright, priority, reviewed, notes
...
-- VIEW bible_filesets_view
-- PKEY fileset_id, asset_id, set_type_code
-- COLS set_size_code, hidden
...
-- VIEW bible_fileset_copyrights_view
-- PKEY fileset_id, asset_id, set_type_code
-- COLS copyright_date, copyright, copyright_description, open_access
...
-- VIEW bible_fileset_copyright_organizations_view
-- PKEY fileset_id, asset_id, set_type_code, organization_id
-- COLS organization_role
...
-- VIEW bible_fileset_tags_view
-- PKEY fileset_id, asset_id, set_type_code, name, language_id
-- COLS description, admin_only, notes, iso
...
-- VIEW access_group_filesets_view
-- PKEY fileset_id, asset_id, set_type_code, access_group_id
-- COLS None
...
-- VIEW bible_files_view
-- PKEY fileset_id, asset_id, set_type_code, book_id, chapter_start, verse_start
-- COLS chapter_end, verse_end, file_name, file_size, duration
...
-- VIEW bible_file_tags_view
-- PKEY fileset_id, asset_id, set_type_code, book_id, chapter_start, verse_start, tag
-- COLS value, admin_only
...
-- VIEW bible_file_video_resolutions_view
-- PKEY fileset_id, asset_id, set_type_code, file_name
-- COLS bandwidth, resolution_width, resolution_height, codec, stream
...
-- VIEW bible_file_video_transport_stream_view
-- PKEY fileset_id, asset_id, set_type_code, file_name
-- COLS runtime
